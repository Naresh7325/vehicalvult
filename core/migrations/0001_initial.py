# Generated by Django 6.0.2 on 2026-04-16 07:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'admin'), ('user', 'user'), ('servicestaff', 'servicestaff')], default='user', max_length=100)),
